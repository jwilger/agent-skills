...
| 1 (Core Process) | `tdd`, `domain-modeling`, `code-review`, `architecture-decisions`, `event-modeling`, `ticket-triage`, `design-system`, `refactoring`, `pr-ship` | 3000 |
| 2 (Team Workflows) | `ensemble-team`, `task-management` | 4000 |
| 3 (Utility) | `debugging-protocol`, `user-input-protocol`, `memory-protocol`, `agent-coordination`, `session-reflection`, `error-recovery` | 3000 |
