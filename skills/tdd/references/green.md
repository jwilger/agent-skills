...
**You MUST NOT create, edit, or delete test files.** If the current
failure requires test changes, STOP and return to RED phase. This is a
...
6. **Fill stubs, do not redefine types.** Implement method bodies for
   types that the domain phase created. When you encounter
...
**Common mistake:** "I know what the full implementation should be, so
I'll write it all at once." Even when you know the answer, the discipline
of one error at a time catches incorrect assumptions and keeps changes
auditable.
